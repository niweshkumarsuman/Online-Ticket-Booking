...
<body>
	...
	<form method="post" name="journeyform" onsubmit="return validate()">
		<select id="trains" name="trains" required>
			...
			<option value="rajdhani" >Rajdhani Express - Ranchi to Delhi</option>
			<option value="hatiayaswantpur" >Hatia Yaswantpur Express - Hatia to Yaswantpur</option>
			<option value="gangadamodar">Ganga Damodar Express - Patna Junction to Dhanbad Junction</option>
			<option value="garibrath" >Garib Rath - Ranchi to Delhi</option>
			<option value="palamu" >Palamu Express - Barkakana Junction to Patna Jn</option>
		</select>
		<br/><br/>
